    ...
    <div className="cc-stage">
      ...
      {step === 2 && (
        <div className="cc-scene">
          ...
          <ChapterVideo src={VID("02-01-add-bookmark.mp4")} caption="↗ 实机演示：添加书签 + AI 自动分类" width={1000} height={420} />
        </div>
      )}
      {step === 3 && (
        <div className="cc-scene">
          ...
          <ChapterVideo src={VID("02-02-cards.mp4")} caption="↗ 实机演示：四种卡片布局" width={1000} height={420} />
        </div>
      )}
      {step === 4 && (
        <div className="cc-scene">
          ...
          <ChapterVideo src={VID("02-04-metadata.mp4")} caption="↗ 实机演示：元数据提取" width={1000} height={420} />
        </div>
      )}
      {step === 5 && (
        <div className="cc-scene cc-scene--with-video">
          ...
          <ChapterVideo src={VID("02-03-detail.mp4")} caption="↗ 实机演示：书签详情面板" width={1000} height={420} />
        </div>
      )}
      {step === 6 && (
        <div className="cc-scene">
          ...
          <ChapterVideo src={VID("02-05-status-toggle.mp4")} caption="↗ 实机演示：阅读状态切换" width={1000} height={420} />
        </div>
      )}
      {step === 7 && (
        <div className="cc-scene">
          ...
          <ChapterVideo src={VID("02-06-status-grid.mp4")} caption="↗ 实机演示：状态视觉区分" width={1000} height={420} />
        </div>
      )}
      {step === 8 && (
        <div className="cc-scene">
          ...
          <ChapterVideo src={VID("02-07-filter.mp4")} caption="↗ 实机演示：状态筛选联动" width={1000} height={420} />
        </div>
      )}
      {step === 9 && (
