...
import { LayoutGrid, Images, BarChart3, Clock, CalendarDays, GitGraph } from "lucide-react";
    ...
    <div className="flex items-center gap-0.5 p-1 rounded-xl bg-[var(--muted)]">
      {TABS.map(({ value, label, icon: Icon }) => (
        <button
          ...
          className={cn(
            "flex items-center gap-1.5 px-3 py-1.5 rounded-[10px] text-[12px] font-medium transition-all font-sans",
            activeView === value
