...
import { ArrowLeft, Download, Share2, Sparkles, ExternalLink } from "lucide-react";
            ...
            <>
              <div className="flex items-center justify-between">
                <p className="text-[13px] text-[var(--muted-foreground)] font-sans">
                  已选 {selectedIds.length} 篇（选择 2-5 篇后点击对比按钮）
                </p>
                <Button
