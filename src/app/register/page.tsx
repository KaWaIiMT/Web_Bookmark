    ...
    return (
      <div className="min-h-screen bg-[var(--background)] flex items-center justify-center">
        <div className="text-center space-y-8">
          ...
          <div className="bg-[var(--card)] backdrop-blur-sm rounded-2xl border border-[var(--border)] p-8 w-[360px] shadow-[0_12px_40px_rgba(0,0,0,0.04)] space-y-6">
